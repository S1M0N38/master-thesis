...
\newglossaryentry{hidden}{
  sort=model,
  name={\ensuremath{h}},
  description={Feature vector produced by the penuiltime hidden layer}
}
...
\newglossaryentry{perturbation}{
  ...
  description={Untargeted perturbation of image. $\epsilon$ is a parameter that controls the magnitude of the perturbation.}
}
\newglossaryentry{perturbation_i}{
  sort=symbols,
  name={\ensuremath{\delta_{\epsilon, c_i}}},
  description={Targeted perturbation of image with the $c_i$ as target class}
}
...
\newglossaryentry{hidden_set}{
  ...
  description={Features vectors set produces by penuiltime hidden layer}
}
\newglossaryentry{hidden_set_i}{
  sort=sets,
  name={\ensuremath{\mathcal{H}_i}},
  description={Features vectors set produces by penuiltime hidden layer of an image with i-th class as ground-truth}
}
