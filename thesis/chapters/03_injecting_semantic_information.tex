...
In order to have a common ground for the following sections, in \Cref{fig:03/framework} we introduce a framework for model for image classification and define its building blocks.
\begin{figure}[htbp]
