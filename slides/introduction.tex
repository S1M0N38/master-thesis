...
\begin{frame}{Introduction | Cross Entropy}
  ...
  \only<2>{
    \vspace{-0.0cm}
    \input{../../../Developer/master-thesis-code/notebooks/figures/one-hot_cross-entropy_1.pgf}
  }
  \only<3>{
    \vspace{-0.0cm}
    \input{../../../Developer/master-thesis-code/notebooks/figures/one-hot_cross-entropy_2.pgf}
  }
  \only<4>{
    \vspace{-0.0cm}
    \input{../../../Developer/master-thesis-code/notebooks/figures/one-hot_cross-entropy_3.pgf}
  }
