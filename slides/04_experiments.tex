\begin{frame}{Experiments | Datasets}
  ...
  \begin{columns}
    ...
    \begin{column}{0.2\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=.7\linewidth]{figures/04/tieredImageNet/example_3.jpg}
        \captionsetup{labelformat=empty, justification=centering, font=scriptsize}
        \caption{\emph{Cliff}}
      \end{figure}
    \end{column}
...
\begin{frame}{Experiments | CIFAR100 --- Performance}
  \input{figures/04/CIFAR100/scatter.pgf}
...
\begin{frame}{Experiments | CIFAR100 --- Description Encodings}
  \input{figures/04/CIFAR100/encodings-level2.pgf}
  \note[item]{Si può anche verificare che per CIFAR100 la struttura gerarchica è
...
\begin{frame}{Experiments | CIFAR100 --- Description Encodings}
  \input{figures/04/CIFAR100/encodings-level3.pgf}
...
\begin{frame}{Experiments | CIFAR100 --- Description Encodings}
  \input{figures/04/CIFAR100/encodings-level4.pgf}
